...
//*****************************************************************************
static void
InitGPIOLCDInterface(unsigned int ulClockMS)
{
    //
...
//    GPIOPinTypeGPIOOutput(LCD_RST_BASE, LCD_RST_PIN);LCD_BACKLIGHT_BASE
    ...
    GPIOPinTypeGPIOOutput(GPIO_PORTA_BASE, 0xF8);
    GPIOPinTypeGPIOOutput(GPIO_PORTB_BASE, 0xFF);
    GPIOPinTypeGPIOOutput(GPIO_PORTC_BASE, 0xF0);
    GPIOPinTypeGPIOOutput(GPIO_PORTD_BASE, 0xCF);
    GPIOPinTypeGPIOOutput(GPIO_PORTE_BASE, 0x3F);
    GPIOPinTypeGPIOOutput(GPIO_PORTF_BASE, 0x1F);
/*	while(1)
	{
	HWREG(GPIO_PORTA_BASE + GPIO_O_DATA + (0xF8 << 2)) = 0xF8;
    HWREG(GPIO_PORTB_BASE + GPIO_O_DATA + (0xFF << 2)) = 0xFF;
    HWREG(GPIO_PORTC_BASE + GPIO_O_DATA + (0xF0 << 2)) = 0xF0;
    HWREG(GPIO_PORTD_BASE + GPIO_O_DATA + (0xCF << 2)) = 0xCF;
    HWREG(GPIO_PORTE_BASE + GPIO_O_DATA + (0x3F << 2)) = 0x3F;
    HWREG(GPIO_PORTF_BASE + GPIO_O_DATA + (0x1F << 2)) = 0x1F;
    SysCtlDelay(ulClockMS);
	HWREG(GPIO_PORTA_BASE + GPIO_O_DATA + (0xF8 << 2)) = 0;
    HWREG(GPIO_PORTB_BASE + GPIO_O_DATA + (0xFF << 2)) = 0;
    HWREG(GPIO_PORTC_BASE + GPIO_O_DATA + (0xF0 << 2)) = 0;
    HWREG(GPIO_PORTD_BASE + GPIO_O_DATA + (0xCF << 2)) = 0;
    HWREG(GPIO_PORTE_BASE + GPIO_O_DATA + (0x3F << 2)) = 0;
    HWREG(GPIO_PORTF_BASE + GPIO_O_DATA + (0x1F << 2)) = 0;
    SysCtlDelay(ulClockMS);
	}
*/
    //
